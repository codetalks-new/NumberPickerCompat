...
public class NumberPicker extends LinearLayout {
	...
	private static class TwoDigitFormatter implements NumberPicker.Formatter {
		...
		private static char getZeroDigit(Locale locale) {
			/// return LocaleData.get(locale).zeroDigit;// fixme
			return '0';
		}
	...
	public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
		...
		mFlingScroller = new Scroller(getContext());//new Scroller(getContext(), null, true);
	...
	public boolean onInterceptTouchEvent(MotionEvent event) {
		...
		final int action = getMaskedAction(event);
		switch (action) {
	...
	private int getMaskedAction(MotionEvent event) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		int action = getMaskedAction(event);
		switch (action) {
	...
	private void showSoftInput() {
		InputMethodManager inputMethodManager = (InputMethodManager) mContext.getSystemService(Context.INPUT_METHOD_SERVICE); // InputMethodManager//InputMethodManager.peekInstance();
